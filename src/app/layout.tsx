...
export default function RootLayout({
  ...
  return (
    <html lang="de" suppressHydrationWarning className={`${sharpGrotesk.variable} ${anton.variable} h-full antialiased`}>
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: "document.documentElement.lang=location.pathname==='/en'||location.pathname.startsWith('/en/')?'en':'de'",
          }}
        />
      </head>
