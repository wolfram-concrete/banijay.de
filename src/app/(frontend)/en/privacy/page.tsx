...
export default function PrivacyPage() {
  return (
    <AlgarveLegalPage title="Privacy" updated="Privacy policy">
      ...
      <h3>2. Applications and career enquiries</h3>
      <p>For formal applications, our careers page links to the external softgarden applicant-management system. Information about processing during that application procedure is provided by softgarden. Once this website’s career form is enabled, you may also use it to send us a career enquiry without an attachment.</p>
      <p>For this purpose, we process your name, optional company, email address, optional telephone number, selected topic and message so that we can respond and consider possible next steps. For enquiries relating to an application, the legal basis is section 26(1) of the German Federal Data Protection Act (BDSG) in conjunction with Art. 88 GDPR. Other pre-contractual enquiries are processed under Art. 6(1)(b) GDPR; otherwise the legal basis is Art. 6(1)(f) GDPR, reflecting our legitimate interest in handling career enquiries. You may object at any time to processing based on Art. 6(1)(f) GDPR by emailing <a href="mailto:datenschutz@banijaygermany.de">datenschutz@banijaygermany.de</a>.</p>
      <p>The form data is processed briefly in a Vercel Function and is not stored persistently there. It is then transmitted by SMTP through the kasserver.com email service operated by ALL-INKL.COM to our recipient mailbox. Recipients are the internal teams handling the enquiry and Vercel and ALL-INKL.COM as technical service providers. The message remains in the recipient mailbox until the enquiry has been fully resolved; statutory retention obligations may require longer storage. The form does not transmit files, CVs or certificates.</p>
      <h3>3. Contact</h3>
      ...
      <p>The vacancy information displayed on our careers page is retrieved server-side from the softgarden applicant-management system. A formal application for a specific vacancy and the associated processing of application documents take place only after you open the correspondingly marked external offer hosted by softgarden. The provider’s privacy information applies there.</p>
