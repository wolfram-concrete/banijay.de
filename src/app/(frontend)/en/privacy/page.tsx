...
export default function PrivacyPage() {
  return (
    <AlgarveLegalPage title="Privacy" updated="Privacy policy">
      ...
      <p>For formal applications, our careers page links to the external softgarden applicant-management system. Information about processing during that application procedure is provided by softgarden. You may also use this website’s career form to send us a career enquiry without an attachment.</p>
