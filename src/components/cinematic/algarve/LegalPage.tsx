...
const RICH = [
  "[&_h2]:mt-[3vw] [&_h2]:mb-[1vw] [&_h2]:text-[1.8vw] [&_h2]:font-medium [&_h2]:leading-[120%] [&_h2]:tracking-[-0.03em] [&_h2]:text-[#0e0d0b]",
  "[&_h2:first-child]:mt-0",
  "[&_h3]:mt-[1.8vw] [&_h3]:mb-[0.6vw] [&_h3]:text-[1.25vw] [&_h3]:font-medium [&_h3]:text-[#0e0d0b]",
  "[&_p]:mb-[1vw] [&_p]:text-[1.05vw] [&_p]:leading-[165%] [&_p]:text-[rgba(0,0,0,0.68)]",
  "[&_ul]:mb-[1vw] [&_ul]:pl-[1.2vw] [&_ul]:list-disc [&_li]:mb-[0.4vw] [&_li]:text-[1.05vw] [&_li]:leading-[160%] [&_li]:text-[rgba(0,0,0,0.68)]",
  "[&_a]:text-[#0e0d0b] [&_a]:underline [&_strong]:font-medium [&_strong]:text-[#0e0d0b]",
...
export function AlgarveLegalPage({
  ...
  return (
    <div style={{ background: "#f8f7f3", fontFamily: SHARP }}>
          ...
          >
            ...
            <div className="flex flex-col items-start self-start md:sticky" style={{ top: "8rem", gap: "1.11vw" }}>
              <h1
                ...
                style={{ fontFamily: SHARP, fontSize: "4.44vw", lineHeight: "108%", fontWeight: 500, letterSpacing: "-0.139vw", color: "#0e0d0b" }}
              >
                {title}
              </h1>
              {updated && (
                <p
                  ...
                  style={{ fontSize: "0.9vw", fontWeight: 700, letterSpacing: "0.052vw", color: "rgba(0,0,0,0.5)" }}
                >
                  {updated}
                </p>
              )}
