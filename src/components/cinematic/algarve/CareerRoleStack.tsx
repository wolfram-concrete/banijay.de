    ...
    >
      <div style={{ paddingLeft: "2vw", paddingRight: "2vw" }}>
        ...
        <div data-roleintro className="max-w-[84vw] max-[767px]:!max-w-full" style={{ marginBottom: "4.5vw" }}>
          {/* Desktop: GROSSE Headline + kleinere Copy getrennt (mobil ausgeblendet). */}
          <h2 className="m-0 flex flex-wrap max-[767px]:!hidden" style={{ fontFamily: SHARP, fontSize: "3.7vw", lineHeight: "108%", fontWeight: 500, letterSpacing: "-0.13vw", color: "#0e0d0b", columnGap: "0.5ch" }}>
          ...
          <p className="m-0 mt-[1.6vw] flex max-w-[48vw] flex-wrap max-[767px]:!hidden" style={{ fontFamily: SHARP, fontSize: "1.3vw", lineHeight: "142%", fontWeight: 500, color: "rgba(14,13,11,0.58)", columnGap: "0.4ch" }}>
          ...
          {/* Mobile: Headline + Copy zu EINEM Copytext zusammengefasst. */}
          <p className="m-0 hidden flex-wrap max-[767px]:!flex" style={{ fontFamily: SHARP, fontSize: "5.6vw", lineHeight: "124%", fontWeight: 500, letterSpacing: "-0.06vw", color: "#0e0d0b", columnGap: "0.34ch" }}>
            {`${CAREER.roleIntro.headline} ${CAREER.roleIntro.text}`.split(" ").map((w, i) => (
              <span key={`m${i}`} data-roleintro-word className="inline-block" style={{ willChange: "transform, opacity" }}>
                {w}
              </span>
            ))}
          </p>
